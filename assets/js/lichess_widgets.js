// Extraído de https://github.com/rubenwardy/lichess_widgets
// Modificado por Taller de Ajedrez (https://tallerdeajedrez.com.ar)
var lichess_widgets = (function() {
	...
	return {
		...
		profile_big: function(theme, author, text) {
			...
			var tmp = "<a id=\"lichess_widget_" + id + "\" class=\"lichess_widget lichess_theme_" + theme;
			tmp    += " lichess_long\" href=\"https://lichess.org/@/" + author + "\" target=\"blank\">";
