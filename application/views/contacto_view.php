...
// require 'vendor/autoload.php'; // Lo comento porque sale error al probarlo
...
if($_POST) {
    ...
    if (isset($response_recaptcha) && $response_recaptcha) {
        $secret = "reemplazar_por_valor_real";
...
<div class="container" style="margin-top: 150px;">
    ...
    <form action="<?= base_url('contacto') ?>" method="post">
        ...
        <div class="form-group row justify-content-end">
            <div class="col-sm-10">
            <div class="g-recaptcha" data-sitekey="reemplazar_por_valor_real" style="margin-bottom: 15px;"></div>
