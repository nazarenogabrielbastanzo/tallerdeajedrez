...
<div class="container mt-3">
    ...
    <form action="<?= base_url('contacto') ?>" method="post">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputNombre" placeholder="Nombre" name="inputNombre" required value="<?= $_POST ? $_POST['inputNombre'] : "" ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row justify-content-end">
            <div class="col-sm-10">
            <div class="g-recaptcha" data-sitekey="<serial_del_sitio>" style="margin-bottom: 15px;"></div>
